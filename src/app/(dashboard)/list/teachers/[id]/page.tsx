    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="bg-white p-4 rounded-md">
        ...
        <div className="mt-4 flex gap-2 flex-wrap text-xs text-gray-500">
          <Link href='/' className="p-2 rounded-md bg-lamaSkyLight">Teachers&apos;s Classes</Link>
          <Link href='/' className="p-2 rounded-md bg-lamaPurpleLight">Teachers&apos;s Students</Link>
          <Link href='/' className="p-2 rounded-md bg-lamaYellowLight">Teachers&apos;s Lessons</Link>
          <Link href='/' className="p-2 rounded-md bg-pink-50">Teachers&apos;s Exams</Link>
          <Link href='/' className="p-2 rounded-md bg-lamaSkyLight">Teachers&apos;s Assignments</Link>
        </div>
      </div>
      <Performance/>
      <Announcement/>
