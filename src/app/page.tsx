...
const Home = () => {
  ...
  return (
    ...
    <div className="container mx-auto p-6">
      <SessionProvider>
        {/* Navbar */}
        <nav className="flex justify-between items-center py-4 bg-white text-black px-6 rounded-lg shadow-md">
          ...
          <ul
            className={`flex-col md:flex-row md:flex space-y-2 md:space-y-0 md:space-x-6 absolute md:border-0 md:static md:bg-transparent w-32 md:w-auto right-5 top-24 md:top-auto md:opacity-0 transition-all text-xl ${
